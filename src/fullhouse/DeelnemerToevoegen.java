...
public class DeelnemerToevoegen extends javax.swing.JFrame {
     ...
     */
    public DeelnemerToevoegen(SpelerView parent) {
        initComponents();
        this.parent = parent;
    }
    ...
    private boolean addSpeler () {
        String query = "INSERT INTO Speler(naam, voorletters, postcode, woonplaats, straatnaam, huisNr, telefoonNr, email, rating, gewonnenGeld,BekendeSpeler)"
                + "VALUES(?,?,?,?,?,?,?,?,?,?,?)";
            try {
            ...
            int rating = 100;
            int gewonnenGeld = 0;
            boolean BekendeSpeler = docentCB.isSelected();
            ...
            stat.setBoolean(11, BekendeSpeler);
