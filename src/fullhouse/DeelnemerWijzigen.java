...
public class DeelnemerWijzigen extends javax.swing.JFrame {
     ...
     */
    public DeelnemerWijzigen(SpelerView parent, int spelerID) {
        initComponents();
        this.parent = parent;
    ...
    private void fillFields() {
        ...
        try {
            ...
            isDocentCB.setSelected(result.getBoolean("BekendeSpeler"));
    ...
    private boolean editSpeler () {
        String query = "UPDATE Speler SET naam=?, voorletters=?, postcode=?, woonplaats=?, straatnaam=?, huisNr=?,"
                + "telefoonNr=?, email=?, rating=?, gewonnenGeld=?, Bekendespeler=? WHERE spelerID=?;";
        try {
            Connection conn = Dataconnection.getConnection();
            PreparedStatement stat = conn.prepareStatement(query);
