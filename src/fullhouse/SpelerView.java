...
public class SpelerView extends javax.swing.JPanel {
    ...
    private void addSpelerBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addSpelerBtnMouseClicked
        DeelnemerToevoegen addSpeler = new DeelnemerToevoegen(this);
    ...
    private void editSpelerBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editSpelerBtnMouseClicked
        ...
        if (row.length == 0) {
            ...
            for (int i = 0; i < row.length; i++) {
                ...
                DeelnemerWijzigen editSpeler = new DeelnemerWijzigen(this, id);
    ...
    private void addInschrijvingBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addInschrijvingBtnMouseClicked
        ...
        if (row.length == 0) {
            ...
            InschrijvingToevoegen inschrijving = new InschrijvingToevoegen(spelers);
    ...
    private void viewInschrijvingenBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_viewInschrijvingenBtnMouseClicked
        ...
        if (row.length > 1) {
            ...
            InschrijvingViewDeelnemer inschrijvingen = new InschrijvingViewDeelnemer(spelerID);
    ...
    private void fillTable(ResultSet result) throws SQLException {
        String[] columnNames = {"ID", "Naam", "Voorletters", "Straatnaam", "HuisNr", "Woonplaats", "Postcode", "Telefoon nr", "E-mail adres", "Rating", "Winsten", "BekendeSpeler"};
        ...
        while (result.next()) {
            ...
            Boolean BekendeSpeler = result.getBoolean("BekendeSpeler");
            Object[] rowData = {ID, naam, voorletters, straatnaam, huisnr, woonplaats, postcode, telefoonNr, email, rating, winsten, BekendeSpeler};
